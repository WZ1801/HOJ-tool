...
try:
    ...
    # 构建命令
    command = f"{sys.executable} -m nuitka main.py --standalone --include-data-dir=static=static --lto=yes --product-name=\"HOJ tool\" --product-version=4.0 --copyright=EchoSearch-MIT"
